...
3- LoadBalancer service.yaml tanımlandığında dışarıdan güvenli bir şekilde içerideki NodePort'a erişim sağlanır aynı zamanıda ClusterIp olarak da tanımlama yapılır.